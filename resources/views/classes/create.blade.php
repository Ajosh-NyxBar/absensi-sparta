                    ...
                    <form action="{{ route('classes.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            <label for="homeroom_teacher_id" class="block text-sm font-semibold text-gray-700 mb-2">
                                <i class="fas fa-user-tie text-blue-600 mr-1"></i> Wali Kelas
                            </label>
                            <select id="homeroom_teacher_id" 
                                    name="homeroom_teacher_id" 
                                    class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 @error('homeroom_teacher_id') border-red-500 @enderror">
