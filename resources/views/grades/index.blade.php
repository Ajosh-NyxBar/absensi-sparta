    ...
    <div class="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
        <form method="GET" action="{{ route('grades.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
                ...
                @php $currentSem = request('semester', $activeSemester->semester ?? ''); @endphp
                <select name="semester" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-rose-500 focus:border-transparent transition-all">
                    ...
                    <option value="Ganjil" {{ $currentSem == 'Ganjil' ? 'selected' : '' }}>{{ __('general.odd') }}</option>
                    <option value="Genap" {{ $currentSem == 'Genap' ? 'selected' : '' }}>{{ __('general.even') }}</option>
                </select>
            </div>
            ...
            <div>
                ...
                <input type="text" name="academic_year" value="{{ request('academic_year', $activeSemester->year ?? '') }}" placeholder="2025/2026" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-rose-500 focus:border-transparent transition-all">
            </div>
